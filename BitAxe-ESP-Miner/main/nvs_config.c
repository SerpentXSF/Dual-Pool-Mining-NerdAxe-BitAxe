...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_POOLB_TLS]                             = {.nvs_key_name = "poolbtls",        .type = TYPE_U16,   .default_value = {.u16 = 0},                                           .rest_name = "poolBTLS",                           .min = 0,  .max = 3},
    ...
    [NVS_CONFIG_POOLB_FB_PORT]                         = {.nvs_key_name = "poolbfbport",     .type = TYPE_U16,   .default_value = {.u16 = 3333},                                        .rest_name = "poolBFallbackPort",                  .min = 0,  .max = UINT16_MAX},
    ...
    [NVS_CONFIG_POOLB_FB_TLS]                          = {.nvs_key_name = "poolbfbtls",      .type = TYPE_U16,   .default_value = {.u16 = 0},                                           .rest_name = "poolBFallbackTLS",                   .min = 0,  .max = 3},
